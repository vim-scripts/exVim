...
if has("gui_running")
    if has("win32")
        ...
        nnoremap <unique> <silent> <C-F5> :call exUtility#Yank(getcwd() . "\\_vimfiles")<CR>
        nnoremap <unique> <silent> <A-F5> :call exUtility#Explore(getcwd() . "\\_vimfiles")<CR>
...
nnoremap <unique> <silent> <Leader>gb :BackwardSearchStack<CR>
nnoremap <unique> <silent> <Leader>gf :ForwardSearchStack<CR>
...
" NOTE: The exEnvironmentSetting must put at the end of the plugin settings. It may update the default settings of plugin above
